...
bool H264Encoder::start(unsigned int width, unsigned int height, unsigned int time_base, unsigned int bitrate, unsigned int gopsize)
{
	assert(width > 0 && height > 0 && time_base > 0 && bitrate > 0 && gopsize > 0);
